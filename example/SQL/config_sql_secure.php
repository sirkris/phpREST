 ...
 * and enter the following command in the Git working directory:  git update-index --no-assume-unchanged config_sql_secure.php
 * When you're done, re-add it to .gitignore and enter the following command:  git update-index --assume-unchanged config_sql_secure.php
 * 
 ...
 * --Kris
 */
$this->sql_pass = "oSERi08pXsQtmYw5Q5TU";
